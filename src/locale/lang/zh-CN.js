export default {
  ...
  property: {
    ...
    uniqueVisitTip: '唯一访问',
    uniqueVisitors: '唯一访客',
    uniqueVisitorsTip: '唯一访客',
    frequencyVisit: '访问频率',
    frequencyVisitTip: '访问频率',
    avgPageView: '平均页面浏览量',
    avgPageViewTip: '平均页面浏览量',
    newVisitors: '新访客',
    newVisitorsTip: '新访客',
    repeatVisitors: '回访访客',
    repeatVisitorsTip: '回访访客',
    bounceRate: '跳出率',
    bounceRateTip: '跳出率',
    avgTimeSpan: '平均逗留时长',
    avgTimeSpanTip: '平均逗留时长',
    performanceSnap: '效果摘要',
    uniqueConv: '唯一转化',
    uniqueConvTip: '唯一转化',
    outOfConv: '于总转化中',
    uniqueCustomers: '唯一转化用户数',
    uniqueCustomersTip: '唯一转化用户数',
    lastMileRatio: '最後转化',
    lastMileRatioTip: '最後转化',
    search: '付费流量',
    nonSearch: '非付费流量',
    timeToConvert: '转化用时',
    timeToConvertTip: '转化用时',
    fullPath: '总转化用时',
    lastMile: '最后转化用时',
    days: '天',
    audienceSnap: '人群摘要',
  ...
  channel: {
    ...
    trafficSourceTip: '热门流量来源',
    trafficTrend: '流量趋势',
    trafficTrendTip: '流量趋势',
    assist: '辅助转化分析',
    assistTip: '辅助转化分析',
    assistNotice: '红色标示：最佳辅助媒体',
    conversionPaths: '热门转化路径',
    conversionPathsTip: '热门转化路径',
    goal: '目标',
    conversion: '转化',
    campaign: '推广',
    topAssist: '渠道 | 媒體',
